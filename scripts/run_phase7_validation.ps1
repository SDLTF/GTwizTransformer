...
$Output = Join-Path $ProjectRoot 'results\phase7_heuristic_validation_20260809'
$Arguments = @(
    ...
    '--models',
    'cora:4571', 'cora:4573', 'cora:4574',
    'citeseer:4571', 'citeseer:4573', 'citeseer:4574',
    'pubmed:4581', 'pubmed:4583', 'pubmed:4584',
    '--targets-per-model', '6',
    '--budgets', '1', '2', '4', '8',
    '--candidate-pool', '128',
